...
Per-version development history. `CHANGELOG.md` is the canonical
crates.io-facing release log; this file is its long-form companion,
documenting each `Cargo.toml` version bump in turn — including versions
that were never published to crates.io.
